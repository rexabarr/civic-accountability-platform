...
import { STATUS_COLORS, STATUS_LABELS, SEVERITY_COLORS, SEVERITY_LABELS, PRIORITY_COLORS, PRIORITY_LABELS, type Severity } from '../types/complaint';
...
export function PriorityBadge({ priority }: { priority: string }) {
  return (
    <span className={clsx('inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium', PRIORITY_COLORS[priority] ?? 'bg-gray-100 text-gray-600')}>
